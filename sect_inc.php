...
<?$APPLICATION->IncludeComponent("bitrix:photogallery.detail.list", "ascetic", array(
	...
	"GALLERY_URL" => "/people/user/#USER_ID#/photo/",
	"DETAIL_URL" => "/people/user/#USER_ID#/photo/photo/#USER_ALIAS#/#SECTION_ID#/#ELEMENT_ID#/",
	"DETAIL_SLIDE_SHOW_URL" => "/people/user/#USER_ID#/photo/photo/#USER_ALIAS#/#SECTION_ID#/#ELEMENT_ID#/slide_show/",
	"SEARCH_URL" => "/search/",
	"CACHE_TYPE" => "A",
	"CACHE_TIME" => "36000000",
	"SET_TITLE" => "N",
